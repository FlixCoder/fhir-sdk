 ...
 */
    ...
    #[builder(
        default,
        setter(
            doc = " # QuantityComparator; < | <= | >= | > | ad - how to understand the value \n\n How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is \"<\" , then the real value is < stated value. \n\n "
        )
    )]
 ...
 */
 ...
 if the number of frames is not supplied, the value may be unknown. Applications should not assume that there is only one frame unless it is explicitly stated. */
    ...
    /// Extension field.
    #[serde(rename = "_frames", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_pages", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
...
/** # Availability
 ...
 ## Availability (FHIR version: 5.0.0)
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_availableTime", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    #[builder(
        default,
        setter(
            doc = " # DaysOfWeek; mon | tue | wed | thu | fri | sat | sun \n\n mon | tue | wed | thu | fri | sat | sun. \n\n "
        )
    )]
    #[serde(rename = "daysOfWeek")]
    pub days_of_week: Vec<Option<codes::DaysOfWeek>>,
    /// Extension field.
    #[serde(rename = "_daysOfWeek", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_allDay", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_during", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
...
/** # CodeableConcept
 ...
 ## CodeableConcept (FHIR version: 5.0.0)
...
/** # CodeableReference
 ...
 ## CodeableReference (FHIR version: 5.0.0)
...
/** # ContactDetail
 ...
 ## ContactDetail (FHIR version: 5.0.0)
...
/** # ContactPoint
 ...
 ## ContactPoint (FHIR version: 5.0.0)
...
/** # Contributor
 ...
 ## Contributor (FHIR version: 5.0.0)
...
/** # DataRequirement
 ...
 ## DataRequirement (FHIR version: 5.0.0)
 ...
 */
 ...
 There can be no stigma associated with the use of extensions by any application, project, or standard - regardless of the institution or jurisdiction that uses or defines the extensions.  The use of extensions is what allows the FHIR specification to retain a core level of simplicity for everyone. */
    ...
    #[serde(rename = "extension")]
    pub extension: Vec<Extension>,
    /** # FHIRTypes; The type of the required data
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_valueFilter", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    #[builder(default, setter(doc = "Field extension."))]
    pub search_param_ext: Option<FieldExtension>,
    /** # ValueFilterComparator; eq | gt | lt | ge | le | sa | eb
 ...
 */
    ...
    #[builder(
        default,
        setter(
            doc = " # ValueFilterComparator; eq | gt | lt | ge | le | sa | eb \n\n The comparator to be used to determine whether the value is matching. \n\n "
        )
    )]
    #[serde(rename = "comparator")]
 ...
 */
 ...
 Can express "as needed" without a reason by setting the Boolean = True.  In this case the CodeableConcept is not populated. */
    ...
    /** # MedicationAsNeededReason; Take "as needed" (for x)
 ...
 Can express "as needed" with a reason by including the CodeableConcept.  In this case the Boolean is assumed to be False, then the dose is given according to the schedule and is not "prn" or "as needed". */
    ...
    #[builder(
        default,
        setter(
            doc = " # MedicationAsNeededReason; Take \"as needed\" (for x) \n\n Indicates whether the Medication is only taken based on a precondition for taking the Medication (CodeableConcept). \n\n Can express \"as needed\" with a reason by including the CodeableConcept.  In this case the Boolean is assumed to be False, then the dose is given according to the schedule and is not \"prn\" or \"as needed\". "
        )
    )]
    #[serde(rename = "asNeededFor")]
    pub as_needed_for: Vec<Option<CodeableConcept>>,
    /// Extension field.
    #[serde(rename = "_asNeededFor", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
...
/** # ElementDefinition
 ...
 ## ElementDefinition (FHIR version: 5.0.0)
 ...
 */
 ...
 Typical extensions that can be provided in place of a the value are [http://hl7.org/fhir/StructureDefinition/data-absent-reason](http://hl7.org/fhir/extensions/StructureDefinition-data-absent-reason.html),  [http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor](http://hl7.org/fhir/extensions/StructureDefinition-iso21090-nullFlavor.html),  [http://hl7.org/fhir/StructureDefinition/originalText](http://hl7.org/fhir/extensions/StructureDefinition-originalText.html), and [http://hl7.org/fhir/StructureDefinition/cqf-expression](http://hl7.org/fhir/extensions/StructureDefinition-cqf-expression.html). Note that this element has no meaning when a value is provided, and extensions can be provided in addition to a value. */
    ...
    /// Extension field.
    #[serde(rename = "_mustHaveValue", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 There can be no stigma associated with the use of extensions by any application, project, or standard - regardless of the institution or jurisdiction that uses or defines the extensions.  The use of extensions is what allows the FHIR specification to retain a core level of simplicity for everyone. */
    ...
    #[serde(rename = "extension")]
    pub extension: Vec<Extension>,
    /** # DiscriminatorType; value | exists | type | profile | position
 ...
 */
 ...
 This element should only be present in a derived profile where a warning or hint has been determined to be spurious/incorrect. E.g. a warning encouraging the inclusion of an element that the profile explicitly prohibits. */
    ...
    /// Extension field.
    #[serde(rename = "_suppress", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_additional", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 There can be no stigma associated with the use of extensions by any application, project, or standard - regardless of the institution or jurisdiction that uses or defines the extensions.  The use of extensions is what allows the FHIR specification to retain a core level of simplicity for everyone. */
    ...
    #[serde(rename = "extension")]
    pub extension: Vec<Extension>,
    /** # AdditionalBindingPurpose; maximum | minimum | required | extensible | candidate | current | preferred | ui | starter | component
 ...
 Conformance bindings are in addition to the base binding, not instead of it. */
    ...
    pub purpose: String,
    /// Extension field.
    #[serde(rename = "_purpose", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_shortDoco", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 This specification does not define exactly how the context is determined for the usage; typically, this will be described in implementation guides. */
    ...
    /// Extension field.
    #[serde(rename = "_usage", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 A common pattern is to make a conformance binding to all repeats, and then make a binding that one of the repeats must conform to. */
    ...
    pub any: Option<bool>,
    /// Extension field.
    #[serde(rename = "_any", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    #[builder(
        default,
        setter(
            doc = " # ExpressionLanguage; text/cql | text/fhirpath | application/x-fhir-query | etc. \n\n The media type of the language for the expression. \n\n "
        )
    )]
    #[serde(rename = "language")]
    pub language: Option<String>,
...
/** # ExtendedContactDetail
 ...
 ## ExtendedContactDetail (FHIR version: 5.0.0)
 ...
 */
 ...
 If no purpose is defined, then these contact details may be used for any purpose. */
    ...
    #[builder(
        default,
        setter(
            doc = " # Purpose; The type of contact \n\n The purpose/type of contact. \n\n If no purpose is defined, then these contact details may be used for any purpose. "
        )
    )]
    #[serde(rename = "purpose")]
 ...
 If there is no named individual, the telecom/address information is not generally monitored by a specific individual. */
    ...
    /// Extension field.
    #[serde(rename = "_name", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 More than 1 address would be for different purposes, and thus should be entered as a different entry,. */
    ...
    /// Extension field.
    #[serde(rename = "_address", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_organization", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
...
/** # MarketingStatus
 ...
 ## MarketingStatus (FHIR version: 5.0.0)
...
/** # MonetaryComponent
 ...
 ## MonetaryComponent (FHIR version: 5.0.0)
 ...
 */
 ...
 There can be no stigma associated with the use of extensions by any application, project, or standard - regardless of the institution or jurisdiction that uses or defines the extensions.  The use of extensions is what allows the FHIR specification to retain a core level of simplicity for everyone. */
    ...
    #[serde(rename = "extension")]
    pub extension: Vec<Extension>,
    /** # PriceComponentType; base | surcharge | deduction | discount | tax | informational
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_amount", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
...
/** # ParameterDefinition
 ...
 ## ParameterDefinition (FHIR version: 5.0.0)
...
/** # ProductShelfLife
 ...
 ## ProductShelfLife (FHIR version: 5.0.0)
 ...
 */
 ...
 Using absolute URLs provides a stable scalable approach suitable for a cloud/web context, while using relative/logical references provides a flexible approach suitable for use when trading across closed eco-system boundaries.   Absolute URLs do not need to point to a FHIR RESTful server, though this is the preferred approach. If the URL conforms to the structure "[type]/[id]" then it should be assumed that the reference is to a FHIR RESTful server. */
    ...
    #[builder(default, setter(doc = "Field extension."))]
    pub reference_ext: Option<FieldExtension>,
    /** # FHIRResourceTypeExt; Type the reference refers to (e.g. "Patient") - must be a resource in resources
...
The type is the Canonical URL of Resource Definition that is the type this reference refers to. References are URLs that are relative to http://hl7.org/fhir/StructureDefinition/ e.g. "Patient" is a reference to http://hl7.org/fhir/StructureDefinition/Patient. Absolute URLs are only allowed for logical models (and can only be used in references in logical models, not resources).
 ...
 This element is used to indicate the type of  the target of the reference. This may be used which ever of the other elements are populated (or not). In some cases, the type of the target may be determined by inspection of the reference (e.g. a known RESTful URL) or by resolving the target of the reference. */
    ...
    #[builder(
        default,
        setter(
            doc = " # FHIRResourceTypeExt; Type the reference refers to (e.g. \"Patient\") - must be a resource in resources \n\n The expected type of the target of the reference. If both Reference.type and Reference.reference are populated and Reference.reference is a FHIR URL, both SHALL be consistent.\n\nThe type is the Canonical URL of Resource Definition that is the type this reference refers to. References are URLs that are relative to http://hl7.org/fhir/StructureDefinition/ e.g. \"Patient\" is a reference to http://hl7.org/fhir/StructureDefinition/Patient. Absolute URLs are only allowed for logical models (and can only be used in references in logical models, not resources). \n\n This element is used to indicate the type of  the target of the reference. This may be used which ever of the other elements are populated (or not). In some cases, the type of the target may be determined by inspection of the reference (e.g. a known RESTful URL) or by resolving the target of the reference. "
        )
    )]
    #[serde(rename = "type")]
...
/** # RelatedArtifact
 ...
 ## RelatedArtifact (FHIR version: 5.0.0)
 ...
 */
 ...
 There can be no stigma associated with the use of extensions by any application, project, or standard - regardless of the institution or jurisdiction that uses or defines the extensions.  The use of extensions is what allows the FHIR specification to retain a core level of simplicity for everyone. */
    ...
    #[serde(rename = "extension")]
    pub extension: Vec<Extension>,
    /** # RelatedArtifactType; documentation | justification | citation | predecessor | successor | derived-from | depends-on | composed-of | part-of | amends | amended-with | appends | appended-with | cites | cited-by | comments-on | comment-in | contains | contained-in | corrects | correction-in | replaces | replaced-with | retracts | retracted-by | signs | similar-to | supports | supported-with | transforms | transformed-into | transformed-with | documents | specification-of | created-with | cite-as
 ...
 The presence of both sides of a relationship type (e.g. successor and predecessor) is required to support use cases where one side of a relationship is not represented in FHIR. However, this feature SHALL NOT be used to create bi-directional resource links in FHIR instances. Specifically, following the methodology of "new points to old" and "many points to one", when using related artifact elements to describe and reference FHIR resources, the type element SHALL be drawn from the fhir-related-artifact-type ValueSet. */
    ...
    #[builder(default, setter(doc = "Field extension."))]
    pub r#type_ext: Option<FieldExtension>,
    /** # RelatedArtifactClassifier; Additional classifiers
 ...
 */
    ...
    #[builder(
        default,
        setter(
            doc = " # RelatedArtifactClassifier; Additional classifiers \n\n Provides additional classifiers of the related artifact. \n\n "
        )
    )]
    #[serde(rename = "classifier")]
    pub classifier: Vec<Option<CodeableConcept>>,
    /// Extension field.
    #[serde(rename = "_classifier", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 If both resource and resourceReference are present, they SHOULD be consistent and reference the same resource. Although relatedArtifact is intended to support references to definitional resources, there are cases where non-definitional resources can be definitional (such as Location where the kind is mode). Related artifacts SHOULD be used to reference definitional resources, and profiles SHOULD be used to make that explicit for particular use cases. */
    ...
    /// Extension field.
    #[serde(
        rename = "_resourceReference",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    #[builder(default, setter(doc = "Field extension."))]
    pub resource_reference_ext: Option<FieldExtension>,
    /** # RelatedArtifactPublicationStatus; draft | active | retired | unknown
 ...
 */
    ...
    #[builder(
        default,
        setter(
            doc = " # RelatedArtifactPublicationStatus; draft | active | retired | unknown \n\n The publication status of the artifact being referred to. \n\n "
        )
    )]
...
/** # SampledData
 ...
 ## SampledData (FHIR version: 5.0.0)
 ...
 */
 ...
 This is usually a whole number. */
    ...
    /// Extension field.
    #[serde(rename = "_interval", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
    ...
    /// Extension field.
    #[serde(rename = "_intervalUnit", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 The ConceptMap cannot define meanings for the codes 'E', 'U', or 'L' (nor 'e', 'u', or 'l'). */
    ...
    /// Extension field.
    #[serde(rename = "_codeMap", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 If offsets is present, the number of data points must be equal to the number of offsets mlutipled by the dimensions. */
    ...
    /// Extension field.
    #[serde(rename = "_offsets", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 Examples include attesting to: authorship, correct transcription, and witness of specific event. Also known as a &quot;Commitment Type Indication&quot;. */
    ...
    #[builder(
        default,
        setter(
            doc = " # SignatureType; Indication of the reason the entity signed the object(s) \n\n An indication of the reason that the entity signed this document. This may be explicitly included as part of the signature information and can be used when determining accountability for various actions concerning the document. \n\n Examples include attesting to: authorship, correct transcription, and witness of specific event. Also known as a &quot;Commitment Type Indication&quot;. "
        )
    )]
    #[serde(rename = "type")]
 ...
 */
 ...
 BID etc. are defined as 'at institutionally specified times'. For example, an institution may choose that BID is "always at 7am and 6pm".  If it is inappropriate for this choice to be made, the code BID should not be used. Instead, a distinct organization-specific code should be used in place of the HL7-defined BID code and/or a structured representation should be used (in this case, specifying the two event times). */
    ...
    #[builder(
        default,
        setter(
            doc = " # TimingAbbreviation; C | BID | TID | QID | AM | PM | QD | QOD | + \n\n A code for the timing schedule (or just text in code.text). Some codes such as BID are ubiquitous, but many institutions define their own additional codes. If a code is provided, the code is understood to be a complete statement of whatever is specified in the structured timing data, and either the code or the data may be used to interpret the Timing, with the exception that .repeat.bounds still applies over the code (and is not contained in the code). \n\n BID etc. are defined as 'at institutionally specified times'. For example, an institution may choose that BID is \"always at 7am and 6pm\".  If it is inappropriate for this choice to be made, the code BID should not be used. Instead, a distinct organization-specific code should be used in place of the HL7-defined BID code and/or a structured representation should be used (in this case, specifying the two event times). "
        )
    )]
    #[serde(rename = "code")]
    pub code: Option<CodeableConcept>,
...
/** # TriggerDefinition
 ...
 ## TriggerDefinition (FHIR version: 5.0.0)
...
/** # UsageContext
 ...
 ## UsageContext (FHIR version: 5.0.0)
...
/** # VirtualServiceDetail
 ...
 ## VirtualServiceDetail (FHIR version: 5.0.0)
...
Some profiles could be used for specific types to define what the other values could/should be. */
    ...
    #[builder(
        default,
        setter(
            doc = " # VirtualServiceType; Channel Type \n\n The type of virtual service to connect to (i.e. Teams, Zoom, Specific VMR technology, WhatsApp). \n\n As this type defines what the virtual service is, it then defines what address and additional information might be relevant.\n\nSome profiles could be used for specific types to define what the other values could/should be. "
        )
    )]
    #[serde(rename = "channelType")]
    pub channel_type: Option<Coding>,
    /// Extension field.
    #[serde(rename = "_channelType", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
 ...
 */
 ...
 This web address can be used to provide additional details on the call, such as alternative/regional call in numbers, or other associated services. */
    ...
    /// Extension field.
    #[serde(rename = "_additionalInfo", default, skip_serializing_if = "Vec::is_empty")]
    #[builder(default, setter(doc = "Field extension."))]
...
This could be in cases where a shared number is used, and a session key is added to put into a private line, or to identify the participant in a call. */
    ...
    /// Extension field.
    #[serde(rename = "_sessionKey", default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(doc = "Field extension."))]
