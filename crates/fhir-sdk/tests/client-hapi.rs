...
macro_rules! impl_hapi_tests {
	...
	($version:ident) => {
		mod $version {
			...
			/// Go through all entries of the bundle, extracting the outcomes and search
			/// for errors inside. Fail if there is any of severity error or fatal.
